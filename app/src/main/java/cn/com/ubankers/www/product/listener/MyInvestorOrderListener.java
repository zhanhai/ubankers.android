...
import com.loopj.android.http.JsonHttpResponseHandler;
	...
	//投资者预约监听事件
	public class MyInvestorOrderListener implements OnClickListener{
			...
			public MyInvestorOrderListener(Context context,String reserveName,ProductDetail product){
