...
import cn.com.ubankers.www.user.model.MycfmpBean;
...
public class QuerencfmpAdapter extends BaseAdapter {
	private Context context;
	private ArrayList<BindCfmpBean> list;
	private int count;

	public QuerencfmpAdapter(Context context,ArrayList<BindCfmpBean> list){
